...
const i18nDict = {
  zh: {
    ...
    desc_style: '建议 3-10 条。输入您收集/过往的高赞推文，AI 将深度模仿行文风格与断句习惯。',
    btn_add_style: '添加新语料',
  ...
  en: {
    ...
    desc_style: '3-10 recommended. Input your collected high-engagement tweets. The AI will deeply mimic the writing style and pacing.',
